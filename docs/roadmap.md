...
sanctioned `create_cash_position` seam (2026-09-04). Open: S4b wizard,
S4c reported-flow surfaces, S5 blotter/history/indicator, S6 pre-trade
preview, S7 Stage-A contract.

...
publication-day walk with `2026.09.1`. Next: full-suite home run
(≥ 5,094), pyright island housekeeping, SB-6 (`enabled` consumer, 24-hour
timer, refresh gesture, panel, suggestion filter, export gesture), B-1
milestone review.
